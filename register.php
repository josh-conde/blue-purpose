...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            echo "<div class='success-message-form container'> Your account has been created! Please follow this <a href='https://thebluepurpose.com>Link</a> to head back to our home page.</a></div> ";
        } else {
